...
public class VueEditDPS extends BorderPane{
    ...
    public VueEditDPS(Controller c,ScrollController sc){
        ...
        this.editButton=new Button("Sauvegarder");
        ...
        this.editButton.setTranslateY(-50);
        this.editButton.setTranslateX(50);
        this.editButton.setOnAction(this.control);


        this.deleteButton=new Button("Supprimer");
        this.deleteButton.setFont(Font.font("Arial", 20));
        ...
        this.deleteButton.setTranslateX(150);
        this.deleteButton.setTranslateY(-50);

        this.bottomBox=new HBox();
        this.bottomBox.getChildren().addAll(this.editButton,this.deleteButton);
        
        this.compbox.setOnScroll(this.scrollController);
        this.scrollController.setEditDPS(this);
