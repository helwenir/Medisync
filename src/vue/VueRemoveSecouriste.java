...
public class VueRemoveSecouriste extends BorderPane{
    ...
    private int imin;
    private int i;
    public VueRemoveSecouriste(Controller c,ScrollController sc,ArrayList<String> l){

        this.i=0;
        this.control=c;
        this.scrollController=sc;
        this.scrollController.setremoveVue(this);
        ...
        this.removeButton.setFont(Font.font("Arial", 30));
        ...
        this.removeButton.setTranslateX(150);
        this.removeButton.setTranslateY(-20);

        this.setTop(this.title);
        this.setCenter(this.centerBox);
        this.setBottom(this.removeButton);
   ...
   public void updateTextSecouristeUp() {
    ...
    public String getNameSecouristeRemove(){
